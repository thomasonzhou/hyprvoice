...
`)
	...
	return writeConfigAtomically(configPath, sb.String())
}
...
`
	...
	return writeConfigAtomically(configPath, configContent)
}

func writeConfigAtomically(configPath, content string) (err error) {
	...
	if err := tmpFile.Sync(); err != nil {
		return fmt.Errorf("failed to sync config content: %w", err)
	}
